                ...
                products.length > 0 ? ( < div className = 'container mx-auto h-auto grid grid-cols-5 gap-8' >
                    ...
                    div > {
                        products.map((item) => ( <
                            ...
                            className = ' bg-red-500 w-36 py-1 rounded-lg text-white mt-2 hover:bg-red-700 active:bg-red-900 duration-300' > Delete Item < /button> <
                            /div> <
                            div >
                            <
                    ...
                    for FREE Shipping Choose this option at checkout.See details... <
                    /p> <
                    div >
                    <
